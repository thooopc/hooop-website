                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                     {SITE_CONTENT.collective.map((member, idx) => (
                         <SoftCard key={idx} className="p-6 md:p-7 flex flex-col sm:flex-row gap-6 md:gap-7 group">
                            ...
                            <div className="relative w-full sm:w-40 md:w-44 aspect-[3/4] rounded-[1.75rem] bg-[#E0E5EC] shadow-[inset_4px_4px_10px_#bebebe,inset_-4px_-4px_10px_#ffffff] shrink-0 self-start">
