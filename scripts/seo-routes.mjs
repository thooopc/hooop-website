...
export const ROUTES = Object.fromEntries([
  ...
  post("marine-circularity-india",
    "Ocean Plastic, Seaweed and the Blue Economy: What Marine Claims Can Actually Be Proved",
    "What ocean-bound plastic actually means, the three ways marine claims fail, whether seaweed packaging is ready, and where the money is. Our current thinking, including what we are still unsure about."),
  ...
  post("sustainable-media-planning-india",
    "Sustainable Media Planning in India: How Cutting Carbon Cuts Wasted Spend",
    "Every rupee is being asked to justify itself. The inventory inflating your campaign's carbon footprint is usually the same inventory that was never going to perform."),
